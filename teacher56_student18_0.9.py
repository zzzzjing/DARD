...
# 设置 0.9 teacher clean, 0.1 teacher adv
# 预定义的辅助函数
...
class DistillationDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        teacher_target = 0.9*self.teacher_clean[index] + 0.1*self.teacher_adv[index]
...
def main():
    ...
    # 保存训练好的学生模型
    torch.save(student_model.state_dict(), "student_resnet18_distilled_0.9.pth")
